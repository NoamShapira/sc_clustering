...
parser.add_argument("--load_labeled_adata_from", type=str, default=str(Path(asaf_meta_cell_dir_path, "scanpy_metacells.h5ad")))
parser.add_argument("--save_labeled_adata_to", type=str, default=str(Path(experiment_results_dir_path, "scanpy_metacells.h5ad")))
