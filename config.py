...
ASAF_SERONO_DIR_PATH = PurePosixPath(AmitLab_Path, 'weiner/Serono')
ASAF_SERONO_META_DATA_DIR_PATH = PurePosixPath(ASAF_SERONO_DIR_PATH, 'Serono11')
ASAF_META_CELL_ATLAS_DIR_PATH = PurePosixPath(
    ASAF_SERONO_DIR_PATH, "Serono14/clustering_results/simple_clustering_2021_09_05__15_04_43")
META_DATA_PATH = PurePosixPath(ASAF_SERONO_META_DATA_DIR_PATH, 'serono11_metadata.txt')
NEW_META_DATA_PATH = PurePosixPath(ASAF_SERONO_META_DATA_DIR_PATH, 'SeronoMetadata13.txt')
